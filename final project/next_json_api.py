...
ETA_3 = datetime.strptime((response_data["Services"][1]["NextBus2"]["EstimatedArrival"]),'%Y-%m-%dT%H:%M:%S+08:00')
ETA_53 = datetime.strptime((response_data["Services"][5]["NextBus2"]["EstimatedArrival"]),'%Y-%m-%dT%H:%M:%S+08:00')
ETA_89 = datetime.strptime((response_data["Services"][7]["NextBus2"]["EstimatedArrival"]),'%Y-%m-%dT%H:%M:%S+08:00')
ETA_109 = datetime.strptime((response_data["Services"][0]["NextBus2"]["EstimatedArrival"]),'%Y-%m-%dT%H:%M:%S+08:00')
